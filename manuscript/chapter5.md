...
Sublime 自带的侧边栏功能很少，右键菜单中只有一些最基本的操作，在实际操作中，我们往往不够。这个插件能增强 Sublime 的侧边栏，增加了大量的操作在右键菜单中，类似于拷贝文件，拷贝路径，新建文件，等等。
...
主题或者配色方案大多也都是采用插件这种形式安装的，由于每个人的喜好都不同，在这里就不做推荐，大家可以去 GitHub 或者 [Package Control](https://packagecontrol.io/) 官网搜索。
